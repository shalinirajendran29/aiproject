...
class FieldMappingEngine:
    def __init__(self):
        ...
        self.synonyms = {
            ...
            "invoice_number": ["invoice_number", "invoice_no", "bill_no", "bill_number", "inv_no", "receipt_no", "inv_num", "invoice number", "invoice no", "bill no", "bill number", "receipt number", "document_no", "doc_no", "voucher_no", "voucher_num"],
            "invoice_date": ["invoice_date", "bill_date", "inv_date", "date_issued", "issue_date", "invoice date", "bill date", "date of issue", "billing_date", "receipt_date", "date"],
            ...
            "gross_weight": ["gross_weight", "gross weight", "gr_wt", "gwt", "gross wt", "grossweight", "total_weight", "total_wt"],
            "net_weight": ["net_weight", "net weight", "nt_wt", "nwt", "net wt", "netweight", "gold_weight", "gold_wt", "metal_weight", "metal_wt"],
            ...
            "rate_per_gram": ["rate", "rate_per_gram", "gold_rate", "rate/gm", "metal_rate", "gold rate", "rate per gram", "silver_rate", "rate/gram", "gold_price"],
            "stone_weight": ["stone_weight", "stone weight", "st_wt", "stone wt", "stone_wt", "stoneweight", "diamond_weight", "diamond_wt", "bead_weight"],
