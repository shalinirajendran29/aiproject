...
const STANDARD_FIELDS = [
  { key: 'full_name', label: 'Customer Name', placeholder: 'e.g. Rajesh Kumar' },
  ...
  { key: 'address', label: 'Address', placeholder: 'e.g. 123 Anywhere St , Any City' },
  { key: 'country', label: 'Country', placeholder: 'e.g. India' },
  { key: 'state', label: 'State', placeholder: 'e.g. Tamil Nadu' },
  { key: 'district', label: 'District', placeholder: 'e.g. Chennai' },
  { key: 'pin_code', label: 'PIN Code', placeholder: 'e.g. 600020' },
  { key: 'pan_no', label: 'PAN NO.', placeholder: 'e.g. ABCDE1234F' },
  { key: 'gstin_no', label: 'GSTIN No.', placeholder: 'e.g. 33ABCDE1234F1Z5' },
  ...
  { key: 'vendor_name', label: 'Vendor Name', placeholder: 'e.g. Global Services Ltd' },
